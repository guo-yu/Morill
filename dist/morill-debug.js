...
**/
define("alipay/morill/0.1.6/morill-debug", [ "$-debug", "./morris-debug.js", "gallery/raphael/2.1.0/raphael-debug", "./morill-debug.css" ], function(require, exports, module) {
    var jQuery = require("$-debug");
    var Morris = require("./morris-debug");
    require("./morill-debug.css");
    (function($) {
            ...
            var init = function(options) {
                ...
                var handlers = {
                    ...
                    line: {
                        ...
                        pointWidths: options.pointWidths,
                        // array
                    ...
                    var activeUpdate = function() {
                        updateChart(method, url, data, function(data) {
                            ...
                            if (data === "error") {
                                ...
                                window[options.id] = setTimeout(activeUpdate, options.ajaxInfo.delay * 1e3);
                            }
                        });
                    };
                    setTimeout(activeUpdate, options.ajaxInfo.delay * 1e3);
                }
                // 没有浮入的时候隐藏
...
define("alipay/morill/0.1.6/morris-debug", [ "$-debug", "gallery/raphael/2.1.0/raphael-debug" ], function(require, exports, module) {
    var jQuery = require("$-debug");
    var Raphael = require("gallery/raphael/2.1.0/raphael-debug");
    (function() {
        ...
        Morris.Area = function(_super) {
            ...
            Area.prototype.fillForSeries = function(i) {
                ...
                return Raphael.hsl(color.h, Math.min(255, color.s * .75), Math.min(255, color.l * 1.25));
            };
